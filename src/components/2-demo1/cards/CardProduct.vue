        ...
        <div class="relative p-4 w-full max-w-3xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-end p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button :data-modal-hide="'default-modal'+product.id" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-100 focus:outline-none bg-primary-900 rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" >Salir</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="my-2 px-2 ">
        ...
        <div class="card__product">
            ...
            <div class="flex flex-col items-center w-4/12 gap-1">
                ...
                <button :data-modal-target="'default-modal'+product.id" :data-modal-toggle="'default-modal'+product.id" class="block text-primary-800 border-b border-primary-800 bg-primary-200 hover:bg-primary-300 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-3 py-1 text-center dark:bg-primary-200  dark:focus:ring-primary-800" type="button">
                    Ver Mas
                </button>
            </div>
...
.modal-overlay {
  background-color: rgba(0, 0, 0, 0.8);
    ...
    .card__product-descriptions-tag{
        @apply block whitespace-nowrap  bg-primary-800 text-primary-100 text-xs font-bold my-2 me-2 px-2.5 py-0.5;
    }

    .card__product-img{
        @apply max-w-32 max-h-32 rounded-2xl overflow-hidden;
    }
</style>